...
class vc_single_image extends tdc_composer_block {
	...
	function render($atts, $content = null) {
		...
		if ( !empty($atts['image']) ) {
			...
			$buffer .= '<a style="background-image: url(\'' . $image_info['url'] . '\');' . $image_height . $image_size . $image_repeat . $image_alignment . '" href="' . esc_url( $atts['image_url'] ) . '" ' . $target . ' rel="bookmark"></a>';
