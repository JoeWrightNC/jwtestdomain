...
//						),
					...
					if ( ! empty( $single_post_mapped_shortcodes ) && 'single' === tdc_util::get_get_val('tdbTemplateType') ) {
                    ...
                    if ( ! empty( $category_page_mapped_shortcodes ) && 'category' === tdc_util::get_get_val('tdbTemplateType') ) {
                    ...
                    if ( ! empty( $tag_page_mapped_shortcodes ) && 'tag' === tdc_util::get_get_val('tdbTemplateType') ) {
                    ...
                    if ( ! empty( $author_page_mapped_shortcodes ) && 'author' === tdc_util::get_get_val('tdbTemplateType') ) {
                    ...
                    if ( ! empty( $search_page_mapped_shortcodes ) && 'search' === tdc_util::get_get_val('tdbTemplateType') ) {
                    ...
                    if ( ! empty( $attachment_page_mapped_shortcodes ) && 'attachment' === tdc_util::get_get_val('tdbTemplateType') ) {
