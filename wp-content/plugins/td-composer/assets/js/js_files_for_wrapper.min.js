...
tdcDebug.log(a);if(a.length){tdcIFrameData.tdcRows=new tdcIFrameData.TdcCollection;var c={};b.each(a,function(a,b,d){tdcIFrameData._getData(e,a,c)});b.isEmpty(c)||(tdcDebug.log(c),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",!0,!1));a={error:e,shortcode:e};tdcIFrameData.checkCurrentData(a);b.isUndefined(a.error)||(tdcDebug.log(a.error),new tdcNotice.notice(c,!0,!1))}return!0}},_initNewContentStructureData:function(a,c,d){c=tdcIFrameData._getContentJSON(a,c);if(c.length){var f=
