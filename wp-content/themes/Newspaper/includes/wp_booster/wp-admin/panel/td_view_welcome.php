...
<div class="td-admin-wrap about-wrap">
    ...
    <div class="td-welcome-header">
        <h1>Welcome to <?php echo TD_THEME_NAME?><br><em>Newsroom Edition</em> <div class="td-welcome-version">V <?php echo TD_THEME_VERSION?></div></h1>
        <div class="about-text">
            This is a modified version of Newspaper, built by IB5k exclusively for The States Newsroom. Contact IB5k for Newsroom-specific support.
        </div>
    </div>
