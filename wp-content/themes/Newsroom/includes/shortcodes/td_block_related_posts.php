...
class td_block_related_posts extends td_block {
    ...
    function render($atts, $content = null) {
        ...
        // extend theme functionalities to show coauthors
        if(function_exists('coauthors_ids')) {
			$authIds = coauthors_ids(null,null,null,null,false);
			$authIdsPrepare = trim(str_replace("and", ",", $authIds));
			$atts['live_filter_cur_post_author'] = $authIdsPrepare; //get the current author
		}
