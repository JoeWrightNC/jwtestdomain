...
class td_module_mx9 extends td_module {
    ...
    function render() {
        ...
        <div class="<?php echo $this->get_module_classes(array("td-big-grid-post-0", "td-big-grid-post", "td-big-thumb")); ?>">
            <?php
                echo $this->get_image_custom('td_741x486');
            ?>
            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <?php if (td_util::get_option('tds_category_module_mx9') == 'yes') { if ($this->post->post_type != "post") {
                    ...
                    <div class="td-module-meta-info">
						...
						<?php 
						$co_authors = show_authors_module($this->post->ID);
						if  (!$co_authors) {
