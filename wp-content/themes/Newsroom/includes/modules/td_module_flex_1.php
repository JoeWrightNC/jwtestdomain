            ...
            <div class="td-module-container td-category-pos-<?php echo $category_position; ?>">
                <?php if( $hide_image == '' ) { ?>
                    <div class="td-image-container">
                        <?php if ($td_category_on == true && $category_position == 'image') { if ($this->post->post_type != "post") {
					...
					echo $this->get_category();
                        ...
                        <?php echo $this->get_image_custom($image_size, true);?>
                    </div>
                <?php } ?>

                <div class="td-module-meta-info">
                    <?php if ($td_category_on == true && $category_position == 'above') { if ($this->post->post_type != "post") {
                    ...
                    <div class="td-editor-date">
                        <?php if ($td_category_on == true && $category_position == '') { if ($this->post->post_type != "post") {
